...
<head>
  ...
  <title>wali Panel | SDN Bontoramba</title>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url('') ?>/dist/css/walilte.min.css">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed text-sm layout-footer-fixed">
  ...
  <div class="wrapper">
    <!-- Navbar -->
    <?= $this->include('wali/layout/navbar'); ?>
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    <?= $this->include('wali/layout/sidebar'); ?>
    ...
    <?= $this->include('wali/layout/footer'); ?>
  ...
  <!-- waliLTE App -->
  <script src="<?= base_url('') ?>/dist/js/walilte.min.js"></script>
